...
/**
 * For more documentation, see the class Zume_Migration in file
 * dt-core/migrations/abstract.php
 */
// @codingStandardsIgnoreLine
class Zume_Migration_Engine
{
    ...
    protected static function get_migrations(): array
    {
        ...
        require_once( "migrations/abstract.php" );
        $filenames = scandir( get_theme_file_path()."/functions/migrations/", SCANDIR_SORT_ASCENDING );
        if ( $filenames === false ) {
        ...
        foreach ( $filenames as $filename ) {
            ...
            if ( $filename[0] === "." || $filename === "abstract.php" ) {
                ...
                require_once( get_theme_file_path()."/functions/migrations/".$filename );
                $migration_name = sprintf( "Zume_Migration_%04d", $got_migration_number );
...
class Zume_Migration_Lock_Exception extends Exception
{
