                    ...
                    <ul class="accordion" data-accordion>
                        ...
                        <li class="accordion-item" data-accordion-item>
                            ...
                            <div class="accordion-content" data-tab-content>
                                <div class="inset">
                                    <p>
                                        <strong><a data-value="20730" data-tool="1" id="god-uses-ordinary-people" class="gmo open-modal"><?php esc_html_e( "God Uses Ordinary People", 'zume' ) ?></a></strong><br>
                                        <?php esc_html_e( "You'll see how God uses ordinary people doing simple things to make a big impact.", 'zume' ) ?>
                                    </p>
                                    <p>
                                        <strong><a data-value="20731" data-tool="2" id="simple-definition-of-disciple-and-church" class="gmo open-modal"><?php esc_html_e( "Simple Definition of Disciple and Church", 'zume' ) ?></a></strong><br>
                                        <?php esc_html_e( "Discover the essence of being a disciple, making a disciple, and what is the church.", 'zume' ) ?>
                                    </p>
                                    <p>
                                        <strong><a data-value="20744" data-tool="13" id="vision-casting-the-greatest-blessing" class="gmo open-modal"><?php esc_html_e( "Vision Casting the Greatest Blessing", 'zume' ) ?></a></strong><br>
                        ...
                        <li class="accordion-item" data-accordion-item>
                            ...
                            <div class="accordion-content" data-tab-content>
                                <p>
                                    <strong><a data-value="20737" data-tool="6" id="consumer-vs-producer-lifestyle" class="gmo open-modal"><?php esc_html_e( "Consumer vs Producer Lifestyle", 'zume' ) ?></a></strong><br>
                                ...
                                <div class="inset">
                                    <p>
                                        <strong><a data-value="20732" data-tool="3" id="spiritual-breathing-is-hearing-and-obeying-god" class="gmo open-modal"><?php esc_html_e( "Spiritual Breathing is Hearing and Obeying God", 'zume' ) ?></a></strong><br>
                                        <?php esc_html_e( "Being a disciple means we hear from God and we obey God.", 'zume' ) ?>
                                    </p>
                                    <p>
                                        <strong><a data-value="20738" data-tool="7" id="how-to-spend-an-hour-in-prayer" class="gmo open-modal"><?php esc_html_e( "How to Spend an Hour in Prayer", 'zume' ) ?></a></strong><br>
                                        <?php esc_html_e( "See how easy it is to spend an hour in prayer.", 'zume' ) ?>
                                    </p>
                                    <p>
                                        <strong><a data-value="20749" data-tool="19" id="the-bless-prayer-pattern" class="gmo open-modal"><?php esc_html_e( "The BLESS Prayer Pattern", 'zume' ) ?></a></strong><br>
                                ...
                                <div class="inset">
                                    <p>
                                        <strong><a data-value="20733" data-tool="4" id="soaps-bible-reading" class="gmo open-modal"><?php esc_html_e( "SOAPS Bible Reading", 'zume' ) ?></a></strong><br>
                                ...
                                <div class="inset">
                                    <p>
                                        <strong><a data-value="20752" data-tool="21" id="3-3-group-meeting-pattern" class="gmo open-modal"><?php esc_html_e( "3/3 Group Meeting Pattern", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20735" data-tool="5" id="accountability-groups" class="gmo open-modal"><?php esc_html_e( "Accountability Groups", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20758" data-tool="26" id="always-part-of-two-churches" class="gmo open-modal"><?php esc_html_e( "Always Part of Two Churches", 'zume' ) ?></a></strong><br>
                                        <?php esc_html_e( "Learn how to obey Jesus' commands by going AND staying.", 'zume' ) ?>
                                    </p>
                                    <p>
                                        <strong><a data-value="20747" data-tool="16" id="the-lords-supper-and-how-to-lead-it" class="gmo open-modal"><?php esc_html_e( "The Lord’s Supper and How To Lead It", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20742" data-tool="11" id="baptism-and-how-to-do-it" class="gmo open-modal"><?php esc_html_e( "Baptism and How To Do It", 'zume' ) ?></a></strong><br>
                                ...
                                <div class="inset">
                                    <p>
                                        <strong><a data-value="20740" data-tool="9" id="the-kingdom-economy" class="gmo open-modal"><?php esc_html_e( "The Kingdom Economy", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20746" data-tool="15" id="eyes-to-see-where-the-kingdom-isnt" class="gmo open-modal"><?php esc_html_e( "Eyes to See Where The Kingdom Isn’t", 'zume' ) ?></a></strong><br>
                            ...
                            <div class="accordion-content" data-tab-content>
                                ...
                                <div class="inset">
                                    ...
                                    <div class="inset">
                                        ...
                                        <p>
                                            <strong><a data-value="20745" data-tool="14" id="duckling-discipleship-leading-immediately" class="gmo open-modal"><?php esc_html_e( "Duckling Discipleship – Leading Immediately", 'zume' ) ?></a></strong><br>
                                            <?php esc_html_e( "Learn what ducklings have to do with disciple-making", 'zume' ) ?>
                                        </p>
                                        <p>
                                            <strong><a data-value="20753" data-tool="22" id="training-cycle-for-maturing-disciples" class="gmo open-modal"><?php esc_html_e( "Training Cycle for Maturing Disciples", 'zume' ) ?></a></strong><br>
                                            <?php esc_html_e( "Learn the training cycle and consider how it applies to disciple making.", 'zume' ) ?>
                                        </p>
                                        <p>
                                            <strong><a data-value="20756" data-tool="24" id="expect-non-sequential-growth" class="gmo open-modal"><?php esc_html_e( "Expect Non-Sequential Growth", 'zume' ) ?></a></strong><br>
                                            <?php esc_html_e( "See how disciple making doesn't have to be linear. Multiple things can happen at the same time.", 'zume' ) ?>
                                        </p>
                                        <p>
                                            <strong><a data-value="20757" data-tool="25" id="pace-of-multiplication-matters" class="gmo open-modal"><?php esc_html_e( "Pace of Multiplication Matters", 'zume' ) ?></a></strong><br>
                                    ...
                                    <div class="inset">
                                        <p>
                                            <strong><a data-value="20739" data-tool="8" id="relational-stewardship-list-of-100" class="gmo open-modal"><?php esc_html_e( "Relational Stewardship – List of 100", 'zume' ) ?></a></strong><br>
                                            <?php esc_html_e( "A tool designed to help you be a good steward of your relationships.", 'zume' ) ?>
                                        </p>
                                        <p>
                                            <strong><a data-value="20741" data-tool="10" id="the-gospel-and-how-to-share-it" class="gmo open-modal"><?php esc_html_e( "The Gospel and How to Share It", 'zume' ) ?></a></strong><br>
                                        ...
                                        <p>
                                            <strong><a data-value="20743" data-tool="12" id="prepare-your-3-minute-testimony" class="gmo open-modal"><?php esc_html_e( "Prepare Your 3-Minute Testimony", 'zume' ) ?></a></strong><br>
                                    ...
                                    <div class="inset">
                                        <p>
                                            <strong><a data-value="20750" data-tool="18" id="a-person-of-peace-and-how-to-find-one" class="gmo open-modal"><?php esc_html_e( "A Person of Peace and How To Find One", 'zume' ) ?></a></strong><br>
                                            <?php esc_html_e( "Learn who a person of peace might be and how to know when you've found one.", 'zume' ) ?>
                                        </p>
                                        <p>
                                            <strong><a data-value="20748" data-tool="17" id="prayer-walking-and-how-to-do-it" class="gmo open-modal"><?php esc_html_e( "Prayer Walking and How To Do It", 'zume' ) ?></a></strong><br>
                        ...
                        <li class="accordion-item" data-accordion-item>
                            ...
                            <div class="accordion-content" data-tab-content>
                                <div class="inset">
                                    ...
                                    <p>
                                        <strong><a data-value="20759" data-tool="28" id="coaching-checklist" class="gmo open-modal"><?php esc_html_e( "Coaching Checklist", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20755" data-tool="55" id="leadership-cells" class="gmo open-modal"><?php esc_html_e( "Leadership Cells", 'zume' ) ?></a></strong><br>
                                    ...
                                    <p>
                                        <strong><a data-value="20760" data-tool="29" id="leadership-in-networks" class="gmo open-modal"><?php esc_html_e( "Leadership in Networks", 'zume' ) ?></a></strong><br>
