...
abstract class Zume_Migration {
    ...
    /**
     * @throws \Zume_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                throw new Zume_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class Zume_Migration_Test_Exception
 */
class Zume_Migration_Test_Exception extends Exception {
}
