        ...
        <div id="content" class="grid-x grid-padding-x training"><div  id="inner-content" class="cell">
                ...
                <div class="grid-x grid-margin-x grid-margin-y vertical-padding">
                    ...
                    <div class="medium-8 small-10 cell center">
                        ...
                        <img src="<?php echo esc_url( get_theme_file_uri() ) ?>/assets/images/pieces_pages/5-walking.svg" />
                            ...
                            <div class="grid-x grid-margin-x grid-margin-y">
                                <div class="cell content-large">
                                    ...
                                    <div class="padding-horizontal-2">
                                        <p><strong><?php esc_html_e("OBSERVATION", 'zume') ?></strong><br><?php esc_html_e( "What do you see? If you see a child’s toy in a yard, you might be prompted to pray for the neighborhood’s children, for families or for schools in the area.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("RESEARCH", 'zume') ?></strong><br><?php esc_html_e( "What do you know? If you’ve read up about the neighborhood, you might know something about the people who live there, or if the area suffers from crime or injustice. Pray about these things and ask God to act.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("REVELATION", 'zume') ?></strong><br><?php esc_html_e( "The Holy Spirit may nudge your heart or bring an idea to mind for a particular need or area of prayer. Listen - and pray!", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("SCRIPTURE", 'zume') ?></strong><br><?php esc_html_e( "You may have read part of God’s Word in preparation for your walk or as you walk, the Holy Spirit may bring a Scripture to mind. Pray about that passage and how it might impact the people in that area.", 'zume' ) ?></p>
                                    </div>
                                </div>
                                <div class="cell content-large">
                                    <h3 class="padding-bottom-1"><?php esc_html_e("Five areas of influence on which to focus prayer:", 'zume') ?></h3>
                                    <div class="padding-horizontal-2">
                                        <p><strong><?php esc_html_e("GOVERNMENT", 'zume') ?></strong><br><?php esc_html_e( "Look for and pray over Government centers such as courthouses, commission buildings or law enforcement offices. Pray for the area’s protection, for justice and for godly wisdom for its leaders.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("BUSINESS AND COMMERCE", 'zume') ?></strong><br><?php esc_html_e( "Look for and pray over Commercial centers such as financial districts or shopping area. Pray for righteous investments and good stewardship of resources. Pray for economic justice and opportunity and for generous and godly givers who put people before profits.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("EDUCATION", 'zume') ?></strong><br><?php esc_html_e( "Look for and pray over Educational centers such as schools and administration buildings, vocational training centers, community colleges and universities. Pray for righteous educators to teach God’s truth and protect the minds of their students. Pray that God would intervene in every effort to promote lies or confusion. Pray that these places would send out wise citizens who have a heart to serve and lead.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("COMMUNICATION", 'zume') ?></strong><br><?php esc_html_e( "Look for and pray over Communication centers such as radio stations, tv stations and newspaper publishers. Pray for God’s Story and the testimony of His followers to be spread throughout the city and around the world. Pray that His message is delivered through His medium to His multitudes and that God’s people everywhere will see God’s work.", 'zume' ) ?></p>
                                        <p><strong><?php esc_html_e("SPIRITUALITY", 'zume') ?></strong><br><?php esc_html_e( "Look for and pray over Spiritual centers such as church buildings, mosques or temples. Pray that every spiritual seeker would find peace and comfort in Jesus and not be distracted or confused by any false religion.", 'zume' ) ?></p>
                                    </div>
                                </div>
                            </div> <!-- grid-x -->
