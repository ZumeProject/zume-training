<?php
/*
Template Name: Zúme Landing List
*/
        ...
        <div class="cell medium-8"><!-- center column -->
            ...
            <div class="grid-x grid-margin-x vertical-padding"> <!-- center grid -->
                ...
                <div class="cell">
                    ...
                    <?php else: ?>
                       <p><?php echo esc_html( $values['zume_pre_video_content'][0] ) ?></p>
                    <?php endif; ?>
                    </div>
                    ...
                    <div class="center">
                        ...
                        <?php else: ?>
                            <p><?php echo esc_html( $values['zume_post_video_content'][0] ) ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <ul class="accordion" data-accordion>
                ...
                <li class="accordion-item" data-accordion-item>
                    ...
                    <div class="accordion-content" data-tab-content>
                        <div class="inset">
                            <p>
                                <strong><a data-value="20730" data-tool="1" class="open-modal"><?php esc_html_e( "God Uses Ordinary People", 'zume' ) ?></a></strong><br>
                                <?php esc_html_e( "You'll see how God uses ordinary people doing simple things to make a big impact.", 'zume' ) ?>
                            </p>
                            <p>
                                <strong><a data-value="20731" data-tool="2"  class="open-modal"><?php esc_html_e( "Simple Definition of Disciple and Church", 'zume' ) ?></a></strong><br>
                                <?php esc_html_e( "Discover the essence of being a disciple, making a disciple, and what is the church.", 'zume' ) ?>
                            </p>
                            <p>
                                <strong><a data-value="20744" data-tool="13"  class="open-modal"><?php esc_html_e( "Vision Casting the Greatest Blessing", 'zume' ) ?></a></strong><br>
                ...
                <li class="accordion-item" data-accordion-item>
                    ...
                    <div class="accordion-content" data-tab-content>
                        ...
                        <div class="inset">
                            <p>
                                <strong><a data-value="20732" data-tool="3" class="open-modal"><?php esc_html_e( "Spiritual Breathing is Hearing and Obeying God", 'zume' ) ?></a></strong><br>
                                <?php esc_html_e( "Being a disciple means we hear from God and we obey God.", 'zume' ) ?>
                            </p>
                            <p>
                                <strong><a data-value="20738" data-tool="7"  class="open-modal"><?php esc_html_e( "How to Spend an Hour in Prayer", 'zume' ) ?></a></strong><br>
                                <?php esc_html_e( "See how easy it is to spend an hour in prayer.", 'zume' ) ?>
                            </p>
                            <p>
                                <strong><a data-value="20749" data-tool="19" class="open-modal"><?php esc_html_e( "The BLESS Prayer Pattern", 'zume' ) ?></a></strong><br>
                        ...
                        <div class="inset">
                            ...
                            <p>
                                <strong><a data-value="20735" data-tool="5" class="open-modal"><?php esc_html_e( "Accountability Groups", 'zume' ) ?></a></strong><br>
                            ...
                            <p>
                                <strong><a data-value="20758" data-tool="26" class="open-modal"><?php esc_html_e( "Always Part of Two Churches", 'zume' ) ?></a></strong><br>
                                <?php esc_html_e( "Learn how to obey Jesus' commands by going AND staying.", 'zume' ) ?>
                            </p>
                            <p>
                                <strong><a data-value="20747" data-tool="16" class="open-modal"><?php esc_html_e( "The Lord’s Supper and How To Lead It", 'zume' ) ?></a></strong><br>
                            ...
                            <p>
                                <strong><a data-value="20742" data-tool="11" class="open-modal"><?php esc_html_e( "Baptism and How To Do It", 'zume' ) ?></a></strong><br>
                        ...
                        <div class="inset">
                            <p>
                                <strong><a data-value="20740" data-tool="9" class="open-modal"><?php esc_html_e( "The Kingdom Economy", 'zume' ) ?></a></strong><br>
                            ...
                            <p>
                                <strong><a data-value="20746" data-tool="15" class="open-modal"><?php esc_html_e( "Eyes to See Where The Kingdom Isn’t", 'zume' ) ?></a></strong><br>
                    ...
                    <div class="accordion-content" data-tab-content>
                        ...
                        <div class="inset">
                            ...
                            <div class="inset">
                                ...
                                <p>
                                    <strong><a data-value="20745" data-tool="14" class="open-modal"><?php esc_html_e( "Duckling Discipleship – Leading Immediately", 'zume' ) ?></a></strong><br>
                                ...
                                <p>
                                    <strong><a data-value="20756" data-tool="24" class="open-modal"><?php esc_html_e( "Expect Non-Sequential Growth", 'zume' ) ?></a></strong><br>
                            ...
                            <div class="inset">
                                <p>
                                    <strong><a data-value="20739" data-tool="8" class="open-modal"><?php esc_html_e( "Relational Stewardship – List of 100", 'zume' ) ?></a></strong><br>
                                    <?php esc_html_e( "A tool designed to help you be a good steward of your relationships.", 'zume' ) ?>
                                </p>
                                <p>
                                    <strong><a data-value="20741" data-tool="10" class="open-modal"><?php esc_html_e( "The Gospel and How to Share It", 'zume' ) ?></a></strong><br>
                                ...
                                <p>
                                    <strong><a data-value="20743" data-tool="12" class="open-modal"><?php esc_html_e( "Prepare Your 3-Minute Testimony", 'zume' ) ?></a></strong><br>
                            ...
                            <div class="inset">
                                <p>
                                    <strong><a data-value="20750" data-tool="18" class="open-modal"><?php esc_html_e( "A Person of Peace and How To Find One", 'zume' ) ?></a></strong><br>
                                    <?php esc_html_e( "Learn who a person of peace might be and how to know when you've found one.", 'zume' ) ?>
                                </p>
                                <p>
                                    <strong><a data-value="20748" data-tool="17" class="open-modal"><?php esc_html_e( "Prayer Walking and How To Do It", 'zume' ) ?></a></strong><br>
                ...
                <li class="accordion-item" data-accordion-item>
                    ...
                    <div class="accordion-content" data-tab-content>
                        <div class="inset">
                            ...
                            <p>
                                <strong><a data-value="20755" data-tool="55" class="open-modal"><?php esc_html_e( "Leadership Cells", 'zume' ) ?></a></strong><br>
                            ...
                            <p>
                                <strong><a data-value="20760" data-tool="29" class="open-modal"><?php esc_html_e( "Leadership in Networks", 'zume' ) ?></a></strong><br>
