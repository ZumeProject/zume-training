            ...
            <div class="grid-x grid-margin-y">
                ...
                <div class="large-8 small-12 cell">
                    ...
                    <div class="grid-x grid-margin-x grid-padding-y">
                        ...
                        <div class="cell">
                            <hr>
                            <h3 class="secondary"><?php esc_html_e( 'What personal information do we collect from the people through our website?', 'zume' ) ?></h3>
                            <ul>
                                <li>
                        ...
                        <div class="cell">
                            <hr>
                            <h3 class="secondary"><?php esc_html_e( 'How do we protect your information?', 'zume' ) ?></h3>
                            <p>
                        ...
                        <div class="cell">
                            <hr>
                            <h3 class="secondary"><?php esc_html_e( 'Do we use "cookies"?', 'zume' ) ?></h3>
                            <p>
                        ...
                        <div class="cell">
                            <hr>
                            <h3 class="secondary"><?php esc_html_e( 'Your Access to and Control Over Information.', 'zume' ) ?></h3>
                            <p>
                        ...
                        <div class="cell">
                            <hr>
                            <h3 class="secondary"><?php esc_html_e( 'Updates', 'zume' ) ?></h3>
                            <p>
