...
// Zume Theme Files
require_once( 'functions/login/login.php' ); // Customize the login page
//require_once( 'functions/login/registration.php' ); // Customize the registration process
require_once( 'functions/login/zume-login-logout-register.php' ); // new Zume registration process
